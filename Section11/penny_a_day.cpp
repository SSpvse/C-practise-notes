...
double pennyFunc(int n, double ammount = 0.01){

    if (n==1){
        return ammount;
    }
    return pennyFunc(--n, ammount*2);
}

int main(){

    int n  = 25;
    std::cout << "pennyfunc answer to n: " << n << "answer: " << pennyFunc(n);

}

/*mplementing a Recursive Function - Save a Penny
